...
- If you do call \`fly_to\` for some *other* reason, **pass \`lat\` and \`lon\` as signed decimal degrees.** West and south are NEGATIVE. If you write "119.5°W" in a sentence, the number is still \`-119.5\`. Dropping that minus sign sends the globe to the opposite side of the planet — 47.5, -119.5 is Washington state; 47.5, 119.5 is northern China. N/S/E/W notation is for your prose only, never for a tool argument.
